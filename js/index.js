...
r = function() {
$('.img').attr('src', (window.devicePixelRatio > 1) ? ((window.devicePixelRatio > 2) ? 'images/img_0140-2817.jpg' : 'images/img_0140-1878.jpg') : 'images/img_0140-939.jpg');};
$(window).resize(r);
r();
initMenu($('#menu-1')[0]);
